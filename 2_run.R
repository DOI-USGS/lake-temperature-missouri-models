...
p2 <- list(
  ...
  tar_target(
    p2_nldas_glm_default_runs,
    {
      ...
      tar_assert_identical(p1_nldas_model_config_filt$site_id,
      ...
      tar_assert_identical(basename(p1_nldas_model_config_filt$meteo_fl),
      ...
      run_glm_cal(
        ...
        model_config = p1_nldas_model_config_filt,
        calibrate = FALSE)
    },
    pattern = map(p1_nldas_model_config_filt, p1_nldas_nml_objects))
